    ...
    <DropdownMenu>
        ...
        <DropdownMenuContent class="w-56">
            ...
            <DropdownMenuRadioGroup v-model="selectedCameraID">
                <DropdownMenuRadioItem v-for="(cam, index) in cameras" :key="index" :value="cam.deviceId">
                    {{ cam.label }}
            ...
            <DropdownMenuRadioGroup v-model="selectedMicID">
                <DropdownMenuRadioItem v-for="(mic, index) in microphones" :key="index" :value="mic.deviceId">
                    {{ mic.label }}
                </DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
            ...
            <DropdownMenuRadioGroup v-model="selectedSpeakerID">
                <DropdownMenuRadioItem v-for="(speaker, index) in speakers" :key="index" :value="speaker.deviceId">
                    {{ speaker.label }}
                </DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
        </DropdownMenuContent>
