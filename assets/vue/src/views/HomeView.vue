    ...
    <div class="container max-w-7xl mx-auto p-6">
        ...
        <div v-if="isInterviewer">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <ActionCard v-for="(action, index) in actions" :key="index" :action="action"
                    @click="handleAction(action.title)"></ActionCard>
            </div>

            <MeetingModal :isOpen="showModal" @close="showModal = false"
        ...
        <div v-else>
            ...
            <div class="mt-8">
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3" v-if="interviews.length > 0">
                    <MeetingCard v-for="(interview, index) in interviews" :key="interview.id" :interview="interview" />
                </div>
